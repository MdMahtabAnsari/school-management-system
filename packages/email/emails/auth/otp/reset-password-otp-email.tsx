...
export function ResetPasswordOTPEmail({ email, otp }: OTPEmailProps) {
...
export const resetPasswordOTPEmailHTML = async (props: OTPEmailProps) =>
    render(<ResetPasswordOTPEmail {...props} />);
