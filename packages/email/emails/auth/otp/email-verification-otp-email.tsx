...
export function EmailVerificationOTPEmail({ email, otp }: OTPEmailProps) {
                    ...
                    <Container className="mx-auto w-full max-w-150 rounded-lg border border-[#eaeaea] bg-white p-8">
                        <Section>
                            ...
                            <Text className="m-0 mb-4 text-sm leading-relaxed text-gray-700">
                                Hi {displayEmail}, use the code below to complete your email verification.
                            </Text>
...
export const emailVerificationOTPEmailHTML = async (props: OTPEmailProps) =>
    render(<EmailVerificationOTPEmail {...props} />);
