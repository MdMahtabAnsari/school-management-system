...
export function ForgotPasswordOTPEmail({ email, otp }: OTPEmailProps) {
    ...
    return (
        <Html>
            <Head />
            <Preview>Your {brand} password reset code</Preview>
            <Tailwind>
                    ...
                    <Container className="mx-auto w-full max-w-150 rounded-lg border border-[#eaeaea] bg-white p-8">
                        <Section>
                            ...
                            <Text className="m-0 mb-4 text-sm leading-relaxed text-gray-700">
                                Hi {displayEmail}, we received a request to reset the password for your account. Use the code below to set up a new password.
                            </Text>
...
export const forgotPasswordOTPEmailHTML = async (props: OTPEmailProps) =>
    render(<ForgotPasswordOTPEmail {...props} />);